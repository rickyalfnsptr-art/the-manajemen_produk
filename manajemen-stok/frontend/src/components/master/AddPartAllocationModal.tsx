      ...
      <div className="bg-white rounded-lg shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden animate-scale-up">
        ...
        <div className="p-4 sm:p-5 bg-gradient-to-r from-blue-900 to-indigo-900 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-sm sm:text-base">Alokasi Part ke PT</h3>
              <p className="text-xs text-blue-200">Tentukan batas Min &amp; Max per Customer PT</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-3.5">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3.5 py-2 bg-slate-50 border border-slate-300 rounded-lg text-slate-900 font-mono text-sm font-bold focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition-all"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3.5 py-2 bg-slate-50 border border-slate-300 rounded-lg text-slate-900 text-sm font-medium focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition-all"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-lg text-slate-800 text-xs font-semibold focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-lg text-slate-800 text-xs font-semibold focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer truncate"
              >
          ...
          {customerName === 'OTHER' && (
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2 bg-slate-50 border border-slate-300 rounded-lg text-slate-800 text-xs font-semibold focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none"
              />
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-3 p-3 bg-blue-50/50 border border-blue-100 rounded-lg">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-slate-900 font-mono text-sm font-bold focus:ring-2 focus:ring-blue-500 outline-none"
              />
              <span className="text-[10px] text-red-600 font-medium mt-0.5 block">🔴 Warning jika ≤ Min</span>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-slate-900 font-mono text-sm font-bold focus:ring-2 focus:ring-blue-500 outline-none"
              />
              <span className="text-[10px] text-amber-600 font-medium mt-0.5 block">🔴 Warning jika ≥ Max</span>
            </div>
          </div>
